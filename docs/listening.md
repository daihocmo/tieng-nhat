...
Tại sao việc nghe nhiều hơn lại có ích đến như vậy, ngay cả khi bạn không hiểu được toàn bộ những gì bạn đang nghe? Mình hơi lười viết câu trả lời nên bạn có thể đọc [cái này](https://old.reddit.com/r/languagelearning/comments/1718xse/what_is_the_actual_science_behind_improving/k3padzl/). Nghe 1 ngoại ngữ thường xuyên sẽ giúp nó "thấm" vào bạn nhanh hơn. Càng nghe nhiều, bạn sẽ càng dễ nhận ra từ, cụm từ và cấu trúc câu, từ đó nâng cao khả năng nghe - hiểu (*Listening regularly to a language helps you internalize it faster. The more you listen, the easier it becomes to recognize words, phrases, and patterns, directly improving your comprehension*). Đồng thời, nghe là phương pháp tiếp nhận ngôn ngữ tự nhiên nhất của con người (trước khi ra đời chữ viết), vậy nên nếu bạn muốn nghe hiểu Tiếng Nhật tốt và có thể giao tiếp với người Nhật, thì bạn CHẮC CHẮN phải NGHE NHIỀU HƠN.
...
Nhưng với những người mới bắt đầu học Tiếng Nhật, mất gốc hay gì đó thì phần lớn những nội dung mọi người xem/nghe sẽ đều incomprehensible (không dễ hiểu). Vậy thì nên làm thế nào? Cứ nghe đi kể cả không hiểu (Để hiểu rõ hơn về câu trả lời này thì hãy xem [Does Input Have to Be "Comprehensible"?](https://www.youtube.com/watch?v=yeOmc1nRGG4)). Tất nhiên, trong quá trình này bạn cũng sẽ phải học thêm từ vựng, ngữ pháp này kia, nhưng bạn sẽ học từ chính những gì bạn nghe/xem/đọc, vì khi từ vựng gắn với ngữ cảnh thì khả năng ghi nhớ của bạn sẽ cao hơn, rất nhiều, so với cách bạn học từ vựng theo chủ đề ở trong giáo trình.

Để tìm hiểu thêm về Lý thuyết đắc thụ ngoại ngữ (Input Hypothesis/Comprehensible Input), bạn có thể xem video này: 
[S.Krashen - Học ngữ pháp phí thời gian, tiêu thụ nội dung thực tế để giỏi ngoại ngữ toàn diện](https://www.youtube.com/watch?v=4Ir4206DfvQ)
...
Bạn hãy đọc [Hướng dẫn tự học Tiếng Nhật](guide.md) với nếu có thể, thực hành [Chương trình tự học Tiếng Nhật 30 ngày](routine.md).
...
- [Comprehensible Japanese](https://www.youtube.com/c/ComprehensibleJapanese/) - Từ dễ đến khó cái gì cũng có.
- [Japanese with Shun](https://www.youtube.com/channel/UCu6sZrHyl4hSS2PvlUo2XZA/) - Ông này gần như toàn dùng cỡ N5 N4 nên siêu dễ hiểu.
...
- [あかね的日本語教室](https://www.youtube.com/channel/UCh-GhnQ7qDQmS6Bz3pGc1Mw/) - Của cô Akane thì nó cũng na ná gần với Tiếng Nhật thực tế rồi đó.
...
1. Bạn có thể dễ dàng phân biệt từ đồng âm (Ý là có Furigana giống nhau ấy). Ví dụ như 以上 hay là 異常 chẳng hạn
2. Giúp bạn nhận diện ranh giới của từ: Người Nhật dựa vào quy tắc lên-xuống của cao độ để biết khi nào một từ kết thúc và một từ mới bắt đầu (Không biết lấy ví dụ gì cho cái này).

Không đúng ở chỗ:

1. Ngữ cảnh gánh đến 90%: Trong giao tiếp thực tế, bạn sẽ không bao giờ nhầm "Đũa" (箸) với "Cây cầu" (橋) vì ngữ cảnh câu quá rõ ràng.
2. Pitch Accent thay đổi theo vùng miền và biến âm: Cao độ chuẩn bạn học trong từ điển là giọng Tokyo. Nhưng khi người Nhật nói nhanh, hoặc khi từ đó đi kèm với trợ từ (が, に, を), hay khi họ nói giọng vùng Kansai... cao độ sẽ bị biến đổi hoàn toàn.
...
(ghi chú: output cũng giúp củng cố input, đọc thêm [You can get very far on pure input, but it will still require some amount of output practice to get to fluency](https://old.reddit.com/r/languagelearning/comments/1bw8km9/is_it_true_that_you_can_speak_fluently_by_just/ky4pl3p/))
